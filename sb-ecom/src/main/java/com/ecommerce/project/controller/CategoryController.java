...
public class CategoryController {
    ...
    public ResponseEntity<CategoryResponse> getAllCategories(
            ...
            @RequestParam(name="sortBy", defaultValue = AppConstants.SORT_CATEGORIES_ORDER, required = false) String sortBy,
    ...
    @Tag(name = "Category APIs", description = "APIs for managing categories")
    @Operation(summary = "Create Categories", description = "API to create new category")
    @ApiResponses({
